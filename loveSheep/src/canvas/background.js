...
export default class Back extends Group {
  
    constructor(props){
        super(props)
        var geometry = new THREE.BoxBufferGeometry( 20, 20, 2 );
        var texture1 = new THREE.TextureLoader().load( 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/982762/noise.png' );
        texture1.wrapS = THREE.RepeatWrapping;
        texture1.wrapT = THREE.RepeatWrapping;
        texture1.minFilter = THREE.LinearFilter;
        var uniforms = {
            u_time: { type: "f", value: 12.0 },
            u_resolution: { type: "v2", value: new THREE.Vector2() },
            u_noise: { type: "t", value: texture1 },
